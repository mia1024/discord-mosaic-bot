...
RUN /bot/env/bin/python -m pip install discord aiohttp cchardet requests pillow flask sqlalchemy  --compile
...
RUN ln -s /bot/credentials.py "/bot/env/lib/python3.9/site-packages/mosaic_bot/credentials.py"
